...
**data 출처**
data는 캐글의 'Big Data Certification KR'에서 가져왔습니다.
[사이트]:<https://www.kaggle.com/code/agileteam/py-t1-2-expected-questions/notebook>
...
소수점이 있는 값은 원래 값에서 올림한 값을 뺐을 때 0이 아니라는 놀리를 이용하겠습니다.
